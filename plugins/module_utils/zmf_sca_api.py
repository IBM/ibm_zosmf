...
def __get_sca_apis():
    ...
    return dict(
        ...
        validateDescriptor=dict(
            method='post',
            url='https://{zmf_host}:{zmf_port}/zosmf/config/security/' + version + '/validate/descriptor?userid={userid}',
            args=dict(
                path=dict(
        ...
        validateResource=dict(
            method='post',
            url='https://{zmf_host}:{zmf_port}/zosmf/config/security/' + version + '/validate?userid={userid}',
            args=resource_dict,
            ok_rcode=200
        ),
        ...
        provisionDescriptor=dict(
            method='post',
            url='https://{zmf_host}:{zmf_port}/zosmf/config/security/' + version + '/provision/descriptor?userid={userid}',
            args=dict(
                path=dict(
                    required=True, type='str', nickname='path_of_security_requirements'
                )
        ...
        provisionResource=dict(
            method='post',
            url='https://{zmf_host}:{zmf_port}/zosmf/config/security/' + version + '/provision?userid={userid}',
            args=resource_dict,
            ok_rcode=200
        )
    )
