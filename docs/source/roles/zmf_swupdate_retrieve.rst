...
Synopsis
--------
- The :strong:`IBM z/OSMF collection` provides an Ansible role, referred to as :strong:`zmf\_swupdate\_retrieve`\ , retrieves the most recent software update process on a software instance.
...
swupdate_process_id
  ...
  The process ID value is set as a variable in both the :strong:`zmf\_swupdate\_start` and :strong:`zmf\_swupdate\_resume` roles to identify the started or resumed software update process.
